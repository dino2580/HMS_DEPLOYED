                ...
                <div className="grid gap-6 md:gap-12">
                  <div className="space-y-4">
                    ...
                    <div className="relative w-full">
                      ...
                      />
                      <input
                        className="pl-8 w-full border border-gray-300 rounded-md py-2 px-3 focus:outline-none focus:ring focus:border-blue-300 bg-gray-700 text-white dark:bg-gray-900 dark:text-gray-100"
                        placeholder="Search..."
                        type="search"
                      />
                    </div>
